...
export type ScreenName = 'language'|'welcome'|'signup'|'roleSelect'|'profileSetup'|'welcomeGift'|'home'|'discover'|'profileView'|'chat'|'chatThread'|'tokenWallet'|'buyTokens'|'referEarn'|'myProfile'|'seoDashboard'|'transactions';
